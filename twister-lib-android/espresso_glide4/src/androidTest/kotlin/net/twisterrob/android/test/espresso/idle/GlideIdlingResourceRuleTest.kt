 ...
 */
class GlideIdlingResourceRuleTest {

	@get:Rule val testName = TestName()
	@get:Rule val server = MockWebServer()
	@get:Rule val glide: TestRule = RuleChain
		.emptyRuleChain()
...
//			assertNotNull("No request made", server.takeRequest(10, SECONDS))
...
//			assertTrue("Timed out", callback.await(10, SECONDS))
...
//									assertTrue(listener.await(10, SECONDS))
//									return false
//								}
//							})
//					)

...
public class Adapters {
	...
	private static class XmlCursorAdapterParser {
		...
		private void parseSelectTag() {
			...
			if (fromName == null) {
				throw new IllegalArgumentException("A select item in " + mResources.getResourceEntryName(mId)
		...
		private void parseBindTag() throws IOException, XmlPullParserException {
			...
			if (fromName == null) {
				throw new IllegalArgumentException("A bind item in " + resources.getResourceEntryName(mId)
		...
		private CursorTransformation findTransformation() {
			...
			if (transformation == null) {
				throw new IllegalArgumentException("A transform item in " + resources.getResourceEntryName(mId)

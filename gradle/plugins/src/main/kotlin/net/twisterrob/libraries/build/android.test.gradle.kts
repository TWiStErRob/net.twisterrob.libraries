 ...
 *
 * UTP's host-side additional-output collection runs `am get-current-user`, which API 21 does not
 ...
 * disables BooleanOption.ENABLE_ADDITIONAL_ANDROID_TEST_OUTPUT for this repository.
 *
 * Disabling the option exposes a second AGP defect: task creation leaves additionalTestOutputDir
